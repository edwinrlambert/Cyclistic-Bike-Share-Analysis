...
Usually rides less than a minute are when customers or workers testing out the bikes, immediately finding an issue and returning it. This can also be accidental rentals or system testing.
